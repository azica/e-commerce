...
import { InterRegularWoff, InterRegularTtf, InterMediumWoff, InterMediumTtf, InterBoldWoff, InterBoldTtf, InterThinWoff, InterThinTtf, InterBoldOtf, InterMediumOtf, InterRegularOtf, InterThinOtf, InterSemiBoldOtf, InterSemiBoldTtf, InterSemiBoldWoff } from "assets/fonts/inter";
...
export const fonts = css`
  @font-face {
    ...
    src:
      ...
      url(${PoppinsRegularEot}) format("opentype");
    font-weight: normal;
    font-style: normal;
  }
    ...
    src:
      ...
      url(${PoppinsMediumEot}) format("opentype");
    font-weight: normal;
    font-style: normal;
  }
  ...
  @font-face {
    ...
    src:
      ...
      url(${PoppinsBoldEot}) format("opentype");
    font-weight: normal;
    font-style: normal;
  }
  ...
  @font-face {
    ...
    src:
      ...
      url(${PoppinsThinEot}) format("opentype");
    font-weight: normal;
    font-style: normal;
  }
// Inter fonts
